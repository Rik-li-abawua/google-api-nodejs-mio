  ...
  export class Resource$Projects$Locations$Clusters {
    ...
    addTokenAuthUser(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+cluster}:addTokenAuthUser').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Clusters$Tokenauthusers {
    ...
    addAuthToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+tokenAuthUser}:addAuthToken').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/tokenAuthUsers').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/authTokens').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
